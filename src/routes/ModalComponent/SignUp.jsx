      ...
      <form>
        <fieldset>
          <div className="sign-input-wrapper">
            ...
            <input
              type="text"
              placeholder="숫자, 영문 대/소문자 포함 5~12자 사이"
              value={signId}
              onChange={idHandler}
              onBlur={idValid ? idChecker : null}
            ></input>
            {/* 조건에 일단 부합하는지 먼저 체크 → 그 다음 중복인지 아닌지 체크 */}
            {!idValid && signId.length > 0 && (
              <small className="input-warning">
                아이디는 숫자, 영문을 포함하여 5~12자 사이여야 합니다.
              </small>
            )}
          ...
          <div className="sign-input-wrapper">
            ...
            {signPassword.length > 0 &&
              ...
              signPasswordCheck !== '' &&
              !passwordSame && (
                <small className="input-warning">비밀번호가 다릅니다.</small>
              )}
          </div>
          <div className="sign-input-wrapper">
            ...
            <input
              type="text"
              placeholder="한글, 영문, 숫자를 사용하여 15자 이하"
              value={signNickname}
              onChange={nicknameHandler}
            ></input>
            {!nicknameValid && signNickname.length > 0 && (
              <small className="input-warning">
          ...
          <div className="sign-input-wrapper">
            ...
            <input
              type="text"
              placeholder="ez2archive@gmail.com"
              value={signEmail}
          ...
          <div className="sign-check">
            ...
            <label htmlFor="signcheck" className="sign-text">
              <strong>
                [필수]{' '}
                <a
                  href="https://ez2archive.notion.site/346c59def42049faa6a1744ccfe73cfe"
                  target="b
              "
                >
                  개인정보 수집 및 이용
